...
//   /* Duplicate class name check (per institute) */
//   const classExists = await ClassesMaster.exists({
//     institute_id: classData.institute_id,
//     class_name: classData.class_name,
//     status: 'active',
...
//   if (classExists) {
//     throw new Error('Class with this name already exists for this institute');
//   }
...
//     if (!teacherExists) {
//       throw new Error('Class teacher does not exist');
//     }

//     /* Check if teacher is already a class teacher in same institute */
//     const teacherAlreadyAssigned = await ClassesMaster.exists({
//       institute_id: classData.institute_id,
//       class_teacher_id: classData.class_teacher_id,
//       status: 'active',
