...
const { uploadInstituteNotice } = require("../middlewares/noticeUploads.middleware");

// ============= INSTITUTE NOTICES =============
router.post("/", uploadInstituteNotice.single("file"), noticeController.createNotice);
...
router.put("/:id", uploadInstituteNotice.single("file"), noticeController.updateNotice);
