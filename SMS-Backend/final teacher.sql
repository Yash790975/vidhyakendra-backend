...
-- here we can add more enums depends on requirement
...
-- in this table the reference_id id will be changed depending upon the requirement
...
-- For now will go for random number between 3-5 but after finalize we have to go for numbersize
        subject_code: {
          bsonType: ["string", "null"],
          description: "Optional short code (MATH101)"
        },
