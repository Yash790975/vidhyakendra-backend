...
// ─── School assessment ────────────────────────────────────────────────────────
const createSchoolAssessmentValidation = Joi.object({
  ...
  institute_type: Joi.string().valid("school").required(),
  ...
  class_id: Joi.string().pattern(objectIdPattern).required().messages({
    ...
    "any.required": "class_id is required for school assessments",
  }),
  section_id: Joi.string().pattern(objectIdPattern).optional().allow(null, ""),
  batch_id: Joi.any().valid(null, "").optional(),
  ...
  academic_year: Joi.string().required().messages({ "any.required": "academic_year is required" }),
  ...
  status: Joi.string().valid("draft", "published", "closed").optional().default("draft"),
  created_by: Joi.string().pattern(objectIdPattern).required().messages({
...
// ─── Coaching assessment ──────────────────────────────────────────────────────
const createCoachingAssessmentValidation = Joi.object({
  institute_id: Joi.string().pattern(objectIdPattern).required().messages({
    "string.pattern.base": "Invalid institute_id format",
    "any.required": "institute_id is required",
  }),
  institute_type: Joi.string().valid("coaching").required(),
  title: Joi.string().required().messages({ "any.required": "title is required" }),
  description: Joi.string().optional().allow(null, ""),
  assessment_type: Joi.string()
    .valid("mcq", "short_answer", "mixed")
  ...
  // Allow ObjectId strings (ignored/nullified by service), or null/empty
  class_id: Joi.string().pattern(objectIdPattern).optional().allow(null, ""),
  section_id: Joi.string().pattern(objectIdPattern).optional().allow(null, ""),
  batch_id: Joi.string().pattern(objectIdPattern).required().messages({
    "string.pattern.base": "Invalid batch_id format",
    "any.required": "batch_id is required for coaching assessments",
  }),
  subject_id: Joi.string().pattern(objectIdPattern).required().messages({
    "string.pattern.base": "Invalid subject_id format",
    "any.required": "subject_id is required",
...
// ─── Update (shared — type-agnostic) ─────────────────────────────────────────
const updateAssessmentValidation = Joi.object({
  title: Joi.string().optional(),
  description: Joi.string().optional().allow(null, ""),
  assessment_type: Joi.string().valid("mcq", "short_answer", "mixed").optional(),
  class_id: Joi.string().pattern(objectIdPattern).optional().allow(null, ""),
  section_id: Joi.string().pattern(objectIdPattern).optional().allow(null, ""),
  batch_id: Joi.string().pattern(objectIdPattern).optional().allow(null, ""),
  subject_id: Joi.string().pattern(objectIdPattern).optional(),
...
//     "any.required": "institute_id is required",
//   }),
//   institute_type: Joi.string().valid("school").required(),   //  locked to "school"
//   title: Joi.string().required().messages({ "any.required": "title is required" }),
//   description: Joi.string().optional().allow(null, ""),
//   assessment_type: Joi.string()
//     .valid("mcq", "short_answer", "mixed")
...
//     "any.required": "institute_id is required",
//   }),
//   institute_type: Joi.string().valid("coaching").required(), // locked to "coaching"
//   title: Joi.string().required().messages({ "any.required": "title is required" }),
//   description: Joi.string().optional().allow(null, ""),
//   assessment_type: Joi.string()
//     .valid("mcq", "short_answer", "mixed")
