...
const createSalaryStructure = async (req, res) => {
  try {
    ...
    const adminId = req.instituteAdmin ? req.instituteAdmin._id : null;
    ...
    if (!req.instituteAdmin || !req.instituteAdmin._id) {
      return res.status(statusCode.UNAUTHORIZED).json(
        apiResponse({
          ...
          result: null,
          message: 'Authentication required to approve salary structure'
        })
      );
    }
...
//     const salaryStructure = await teacherSalaryStructureService.createSalaryStructure(req.body);
...
//     const salaryStructure = await teacherSalaryStructureService.updateSalaryStructure(req.params.id, req.body);
...
// const archiveSalaryStructure = async (req, res) => {
//   try {
//     const salaryStructure = await teacherSalaryStructureService.archiveSalaryStructure(req.params.id);
...
// const getSalaryStructuresByTeacherId = async (req, res) => {
//   try {
//     const salaryStructures = await teacherSalaryStructureService.getSalaryStructuresByTeacherId(req.params.teacherId);
...
// const getActiveSalaryStructureByTeacherId = async (req, res) => {
//   try {
//     const salaryStructure = await teacherSalaryStructureService.getActiveSalaryStructureByTeacherId(req.params.teacherId);
