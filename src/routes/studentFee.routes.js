...
// Query filters: institute_id, student_id, academic_year, class_id, batch_id, status
...
// Get student fees by batch ID (coaching-compatible)
// Query filters: academic_year, status
router.get(
  "/student-fee/batch/:batch_id",
  studentFeeController.getStudentFeesByBatchId
);
