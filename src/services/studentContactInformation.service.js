...
//   const existing = await StudentContactInformation.findOne({
//     student_id: contactData.student_id,
//   });

//   if (existing) {
//     throw new CustomError(
//       "Contact information already exists for this student",
//       statusCode.CONFLICT
//     );
//   }
...
// const updateContact = async (studentId, updateData) => {
//   const contact = await StudentContactInformation.findOne({
//     student_id: studentId,
//   });
...
// // Delete contact by student id
// const deleteContact = async (studentId) => {
//   const contact = await StudentContactInformation.findOneAndDelete({
//     student_id: studentId,
//   });
