...
const createAssessment = async (assessmentData) => {
  ...
  const assessment = new Assessments({
    ...
    // class_id and section_id allowed for both school and coaching
    // batch_id only for coaching, forced null for school
...
const updateAssessment = async (assessmentId, updateData) => {
  ...
  // For school assessments, batch_id must stay null
