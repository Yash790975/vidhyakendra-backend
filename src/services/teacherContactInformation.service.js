...
const createContact = async (contactData) => {
  ...
  // Auto-create teacher_auth entry and send credentials email
  try {
    await createTeacherAuth({
      teacher_id: contactData.teacher_id,
    ...
    // Log but don't fail — contact is already saved successfully
    console.error("Failed to auto-create teacher auth:", authError.message);
  }
